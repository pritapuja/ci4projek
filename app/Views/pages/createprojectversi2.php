...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <div class="accordion" id="accordionExample">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                        <div class="card-body">
                            <form action="/pages/save" class="formprojek" method="POST" enctype="multipart/form-data">
                                ...
                                <button type="submit" class="btn btn-primary my-3 mx-3 float-right btnsimpan">Save</button>
                            </form>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                        <div class="card-body">
                            <form class="formActor" method="POST" action="pages/simpan">
                                <?= csrf_field(); ?>
                                <div class="form-group row">
                                    <div class="col-sm-11">
            ...
            <!-- <button type="submit" class="btn btn-primary mt-3 float-right btnsimpanaktor">Save</button> -->
        </div>
    </div>
</div>
<?= $this->endSection(); ?>