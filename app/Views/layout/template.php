...
<head>
    ...
    <link href="<?= base_url() ?>/vendor/node_modules/sweetalert2/dist/sweetalert2.min.css" rel="stylesheet" type="text/css">

    <script src="<?= base_url() ?>/vendor/node_modules/sweetalert2/dist/sweetalert2.all.min.js"></script>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Our Team <?= date('Y'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
